// features/supervisor/presentation/screens/supervisor_main_navigation.dart
...
class SupervisorMainNavigation extends StatefulWidget {
  ...
  const SupervisorMainNavigation({
    super.key,
  ...
  @override
  State<SupervisorMainNavigation> createState() =>
      _SupervisorMainNavigationState();
}
...
class _SupervisorMainNavigationState extends State<SupervisorMainNavigation> {
  ...
  void initState() {
    ...
    _screens = [
      ...
      const SupervisorNotificationsScreen(),
