...
class _PermissionsScreenState extends State<PermissionsScreen> {
  ...
  Widget build(BuildContext context) {
    final crossAxis =
        l.isArabic ? CrossAxisAlignment.end : CrossAxisAlignment.start;

    return Scaffold(
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      appBar: AppBar(
        backgroundColor: Theme.of(context).colorScheme.surface,
        title: Text(l.permissionsTitle,
            style: GoogleFonts.cairo(
              color: _isDark ? AppColors.textPrimary : Colors.black87,
              fontWeight: FontWeight.bold,
              fontSize: AppDimensions.fontLarge(context),
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: _isDark ? AppColors.inputFill : AppColors.inputFillLight,
  ...
  Widget _buildMyPermissions() {
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment:
              l.isArabic ? MainAxisAlignment.end : MainAxisAlignment.start,
          children: [
            if (!l.isArabic) ...[
