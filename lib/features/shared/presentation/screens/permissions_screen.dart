...
class _PermissionsScreenState extends State<PermissionsScreen> {
  ...
  // ← الأنواع والمدد تُترجم ديناميكياً
  ...
  List<Map<String, String>> get _durations => [
    {'value': '15', 'label': '15 ${l.isArabic ? "دقيقة" : "min"}'},
    {'value': '30', 'label': '30 ${l.isArabic ? "دقيقة" : "min"}'},
    {'value': '45', 'label': '45 ${l.isArabic ? "دقيقة" : "min"}'},
    {'value': '60', 'label': '1 ${l.isArabic ? "ساعة" : "hr"}'},
    {'value': '90', 'label': '1.5 ${l.isArabic ? "ساعة" : "hr"}'},
    {'value': '120', 'label': '2 ${l.isArabic ? "ساعة" : "hr"}'},
  ];
  ...
  Future<void> _onSubmit() async {
    ...
    final selectedDur = _durations.firstWhere(
    ...
    try {
      await _repo.submitPermission(
        idNumber: _idNumber,
        type: _selectedType,
        reason: _selectedType == 'other' ? _reasonCtrl.text.trim() : null,
                ...
                children: [
                    ...
                    child: _selectedType == 'other'
                        ? Column(
                            crossAxisAlignment: l.isArabic
                                ...
                                : CrossAxisAlignment.start,
                            children: [
                              _buildLabel(l.permissionReason),
                              SizedBox(
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: _durations.map((d) {
                      return DropdownMenuItem(
                        value: d['value'],
                        child: Text(d['label']!, textAlign: textAlign),
                      );
                    }).toList(),
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  _types[permission.type] ?? permission.type,
                  style: GoogleFonts.cairo(
                    color: _isDark ? AppColors.textPrimary : Colors.black87,
                    fontSize: AppDimensions.fontMedium(context),
                    fontWeight: FontWeight.bold,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${permission.requestDate} · ${permission.duration}',
                  style: GoogleFonts.cairo(
                    color: _isDark ? AppColors.textSecondary : Colors.black54,
